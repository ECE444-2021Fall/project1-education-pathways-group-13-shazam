...
const courseA =     {
    ...
    description: "Successful software projects require more than just technical expertise. Figuring out what the client "+
...
export const courses = [courseA, courseB, courseA, courseA, courseB, courseA, courseA, courseB, courseA, courseA, courseB, courseA];

export const user = {
    firstname: "James",
    lastname: "Bond",
    cart: [
        courseA, courseB, courseA,
        courseA, courseB, courseA,
        courseA, courseB, courseA
    ]
};
